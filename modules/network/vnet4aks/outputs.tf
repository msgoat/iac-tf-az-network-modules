...
output "application_gateway_subnet_cidr" {
  ...
  value = azurerm_subnet.gateway.address_prefix
}
...
output "loadbalancer_subnet_cidr" {
  ...
  value = azurerm_subnet.loadbalancer.address_prefix
}

output "node_groups_subnet_id" {
  description = "Unique identifier of the AKS worker nodes subnet"
  value = azurerm_subnet.nodegroups.id
}

output "node_groups_subnet_name" {
  description = "Name of the AKS worker nodes subnet"
  value = azurerm_subnet.nodegroups.name
}

output worker_nodes_subnet_cidr {
  description = "The CIDR address block associated with the worker nodes network."
  value = azurerm_subnet.nodegroups.address_prefix
}
...
output bastion_subnet_cidr {
  ...
  value = azurerm_subnet.bastion.address_prefix
}
...
output admin_subnet_cidr {
  ...
  value = azurerm_subnet.admin.address_prefix
}
...
output private_endpoint_subnet_cidr {
  ...
  value = azurerm_subnet.endpoints.address_prefix
}
